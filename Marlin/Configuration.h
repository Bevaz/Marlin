...
#define DEFAULT_ACCELERATION          (4000/2)    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  (3000/2)   // X, Y, Z and E max acceleration in mm/s^2 for retracts
